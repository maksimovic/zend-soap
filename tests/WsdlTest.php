...
class Zend_Soap_WsdlTest extends TestCase
{
    ...
    public function testSettingUnknownStrategyThrowsException(): void
    {
    ...
    public function testSettingInvalidStrategyObjectThrowsException(): void
    {
        $this->expectException(Zend_Soap_Wsdl_Exception::class);
