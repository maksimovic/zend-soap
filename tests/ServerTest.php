...
class Zend_Soap_ServerTest extends TestCase
{
    ...
    public function testAddBogusFunctionAsInteger(): void
    {
    ...
    public function testAddBogusFunctionsAsString(): void
    {
        $this->expectException(Zend_Soap_Server_Exception::class);
        $server = new Zend_Soap_Server();
    ...
    public function testAddBogusFunctionsAsArray(): void
    {
        $this->expectException(Zend_Soap_Server_Exception::class);
        $server = new Zend_Soap_Server();
    ...
    public function testSetClass(): void
    {
        ...
        $this->assertStringContainsString('testFunc1', implode(',', $server->getFunctions()));
    }
    ...
    public function testSetClassWithArguments(): void
    {
        $server = new Zend_Soap_Server();
    ...
    public function testSetBogusClassWithIntegerName(): void
    {
        $this->expectException(Zend_Soap_Server_Exception::class);
        $server = new Zend_Soap_Server();
        $server->setClass(465);
    ...
    public function testSetBogusClassWithUnknownClassName(): void
    {
        $this->expectException(Zend_Soap_Server_Exception::class);
        $server = new Zend_Soap_Server();
    ...
    public function testSetObjectOnlyOnce(): void
    {
        $this->expectException(Zend_Soap_Server_Exception::class);
        $server = new Zend_Soap_Server();
    ...
    public function testSetUnknownPersistenceStateThrowsException(): void
    {
        $this->expectException(Zend_Soap_Server_Exception::class);
        $server = new Zend_Soap_Server();
    ...
    public function testLoadFunctionsIsNotImplemented(): void
    {
        $this->expectException(Zend_Soap_Server_Exception::class);
        $server = new Zend_Soap_Server();
     ...
     * @group ZF-5597
     */
    public function testServerAcceptsZendConfigObject(): void
    {
